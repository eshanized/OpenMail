...
<div class="mt-6 pt-4 border-t border-border">
    <h3 class="text-lg font-medium text-ink mb-3 flex items-center">
        <svg class="w-5 h-5 text-ink-tertiary mr-2" fill="currentColor" viewBox="0 0 20 20">
    ...
    @if(empty($attachments))
        <p class="text-ink-tertiary text-sm">No attachments</p>
    @else
        <div class="space-y-2">
            @foreach($attachments as $attachment)
                <div class="flex items-center p-3 bg-surface-sunken rounded-lg border border-border-subtle">
                    {{-- File icon based on MIME type --}}
                    <div class="w-10 h-10 flex-shrink-0 flex items-center justify-center bg-white rounded border border-border">
                        @php
                        ...
                        @else
                            <svg class="w-5 h-5 text-ink-tertiary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-3 flex-1 min-w-0">
                        <p class="text-sm font-medium text-ink truncate">{{ $attachment['name'] }}</p>
                    ...
                    <button
                        ...
                        class="ml-3 flex-shrink-0 px-3 py-1.5 text-sm font-medium text-white bg-primary rounded-lg hover:bg-primary-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
