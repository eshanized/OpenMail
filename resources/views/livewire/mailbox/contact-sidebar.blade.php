<div>
    ...
    <div class="p-4 border-b border-gray-200 flex items-center justify-between">
        ...
        <button
            ...
            class="inline-flex items-center px-3 py-1.5 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        >
    ...
    <div class="p-4 border-b border-gray-200">
        <div class="relative">
            <input
                ...
                class="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            >
    ...
    <div class="flex-1 overflow-y-auto">
        ...
        @elseif($contacts->isEmpty())
            <div class="p-8 text-center">
                ...
                <p class="mt-1 text-sm text-gray-500">Add contacts manually or import a vCard file.</p>
